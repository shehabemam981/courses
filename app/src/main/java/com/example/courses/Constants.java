...
public interface Constants {
    final String androidCourse="android";
    final String iosCourse="ios";
    final String fullStackCourse="full stack";
    final String course="course";
    final String androidDetailed = "Part 1 ( Java SE)\n" +
    ...
    final String fullStackDetailed = "•HTML\t\n" +
            "•HTML 5 \n" +
            "•CSS\n" +
            "•CSS3\n" +
            "•SASS\n" +
    ...
    final String iosDetailed = "a. Installing OS X virtual machine\n" +
